var authConfig = {
    "siteName": "Apple - Drive", // Site Name
    "version" : "2.4", // version
    ...
    "refresh_token": "1//0gETLERfHAh8vCgYIARAAGBASNwF-L9Irw0EfnQqFUH_UWtrzwtcOGRgca2kvNtE0wG0F1NTr_bGkH9LIabqzYsl2vgFNyfw3lOg", // Authorization token
  ...
  <head>
      ...
      <script src="//cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js,gh/preethi4848/SallyNavigate@${authConfig.version}/themes/${authConfig.theme}/app.js"></script>
  </head>
  <body>
  </body>
  </html>
  ...
  function unauthorized() {
    return new Response('401 NOT AUTHORIZED', {
      headers: {
        'WWW-Authenticate': 'Basic realm="Access to Apple Drive", charset="UTF-8"',
